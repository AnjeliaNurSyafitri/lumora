                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="absolute inset-0 flex items-center justify-center">
                                        <div className="flex h-60 w-44 items-center justify-center rounded-[1.5rem] border border-white/60 bg-[#F8F3EF]/80 shadow-xl transition-transform duration-500 group-hover:scale-105 group-hover:shadow-2xl sm:h-64 sm:w-48">
                                            <div className="text-center">
                                                <span className="inline-block text-3xl text-[#4A3048] transition-transform duration-500 group-hover:rotate-12 group-hover:scale-110">
                                                    ✦
                                                </span>
                                    ...
                                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[#4A3048]/80 via-[#4A3048]/30 to-transparent p-7 pt-24 sm:p-8 sm:pt-28">
                                        <div className="flex items-end justify-between gap-5">
                                            ...
                                            <Link
                                                ...
                                                className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-white text-[#4A3048] transition-all duration-300 hover:scale-110 hover:-translate-y-0.5"
                                            >
                                                <ArrowUpRight
                                                    size={18}
                                                    strokeWidth={1.5}
                ...
                <div className="mx-auto grid w-full max-w-[1280px] grid-cols-1 items-center gap-12 px-5 py-16 sm:px-8 lg:grid-cols-2 lg:gap-20 lg:px-10 lg:py-24">
                    ...
                    <Reveal duration={800}>
                        <div className="relative flex min-h-[420px] items-center justify-center overflow-hidden rounded-[2rem] bg-[#DDD3DC] sm:min-h-[500px]">
                            ...
                            {/* Product */}
                            <div className="relative flex h-72 w-52 items-center justify-center rounded-[1.5rem] border border-white/60 bg-[#F8F3EF] shadow-2xl transition-all duration-500 hover:scale-105 hover:shadow-[0_25px_60px_rgba(74,48,72,0.15)] sm:h-80 sm:w-56">

                                <div className="text-center">
                                    <span className="inline-block text-4xl text-[#4A3048] transition-transform duration-500 hover:rotate-12">
                                        ✦
                                    </span>
                            ...
                            {/* Floating Label */}
                            <div className="absolute bottom-6 left-6 rounded-2xl border border-white/50 bg-white/70 px-5 py-4 backdrop-blur-md transition-transform duration-500 hover:-translate-y-1">
            ...
            <section className="border-t border-[#E9E2DA] bg-[#FCFAF7]">
                <Reveal duration={700}>
                    <div className="mx-auto flex w-full max-w-[1280px] flex-col items-center px-5 py-20 text-center sm:px-8 lg:px-10">
                        ...
                        <Link
                            to="/shop"
                            className="group mt-7 inline-flex items-center gap-2 rounded-full bg-[#4A3048] px-7 py-3.5 text-sm font-medium text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#362336] hover:shadow-lg"
                        >
                            Explore Shop
