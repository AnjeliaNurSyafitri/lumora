    ...
    return (
        <section className="bg-[#FCFAF7] py-20 sm:py-24">
            <div className="mx-auto w-full max-w-[1280px] px-5 sm:px-8 lg:px-10">
                <div className="group relative overflow-hidden rounded-[2rem] bg-[#4A3048]">

                    {/* Decorative Elements */}
                    <div className="promo-float absolute -right-24 -top-24 h-72 w-72 rounded-full bg-[#8A5A83]/40" />

                    <div className="promo-float-reverse absolute -bottom-32 -left-20 h-80 w-80 rounded-full bg-[#CBB5C8]/20" />

                    <div className="promo-pulse absolute right-[25%] top-10 h-3 w-3 rounded-full bg-[#E9DDE7]" />

                    <div className="promo-pulse-slow absolute bottom-16 right-[38%] h-2 w-2 rounded-full bg-[#D9C4D5]" />
